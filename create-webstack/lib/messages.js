...
exports.help = function () {
  return `
    ...
    If you have any problems, do not hesitate to file an issue:
      ${chalk.cyan('https://github.com/wooritech/webstack/issues/new')}
  `;
};

exports.templateHelp = function () {
  return `Template from https://github.com/wooritech/webstack/templates/ ${output.param('template-name')}`;
};
...
For example:
  ...
  ${chalk.cyan(program.name)} ${chalk.green('my-basic-app')}
  ${chalk.cyan(program.name)} ${chalk.green('my-basic-app')} ${chalk.cyan('--template basic')}
...
exports.start = function (projectName) {
  ...
  return `
  ${chalk.green('Good!')} You're now ready to start coding.
  ...
  $ ${output.cmd(commands.dev)} (or) watch your package.json

  Questions? Feedback? Please let us know!

  ${chalk.green('https://github.com/wooritech/webstack/issues')}
`;
};
